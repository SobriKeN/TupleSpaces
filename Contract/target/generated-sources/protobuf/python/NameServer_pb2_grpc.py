...
class NameServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.register = channel.unary_unary(
                '/pt.ulisboa.tecnico.nameserver.contract.NameServer/register',
        ...
        self.lookup = channel.unary_unary(
                '/pt.ulisboa.tecnico.nameserver.contract.NameServer/lookup',
        ...
        self.delete = channel.unary_unary(
                '/pt.ulisboa.tecnico.nameserver.contract.NameServer/delete',
...
def add_NameServerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pt.ulisboa.tecnico.nameserver.contract.NameServer', rpc_method_handlers)
...
class NameServer(object):
    ...
    def register(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pt.ulisboa.tecnico.nameserver.contract.NameServer/register',
    ...
    def lookup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pt.ulisboa.tecnico.nameserver.contract.NameServer/lookup',
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pt.ulisboa.tecnico.nameserver.contract.NameServer/delete',
