...
public class CommandProcessor {
    ...
    private void put(String[] split){
        ...
        // put the tuple
        System.out.println(getClientService().put(tuple));
    ...
    private void read(String[] split){
        ...
        // read the tuple
        System.out.println(getClientService().read(tuple));
    }
    ...
    private void take(String[] split){
        ...
        // take the tuple
        System.out.println(getClientService().take(tuple));
    }
    ...
    private void getTupleSpacesState(String[] split){
        ...
        List<String> tuples = getClientService().getTupleSpacesState(qualifier);
